            ...
            <Section className="bg-[#F4F1EA]">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-[#0F2027]">Hablemos de tu Negocio</h1>
                    </div>

                    <div className="grid md:grid-cols-2 gap-8 items-start">
                        {/* Contact Info */}
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 space-y-8">
                            <h3 className="text-2xl font-bold text-[#0F2027] mb-6">Información de Contacto</h3>

                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <div className="bg-[#0F2027]/5 p-3 rounded-lg text-[#CCA43B]">
                                        <Phone size={24} />
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 font-medium">Teléfono / WhatsApp</p>
                                        <a href="tel:+56912345678" className="text-lg font-bold text-[#0F2027] hover:text-[#CCA43B] transition-colors">
                                            +56 9 1234 5678
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:contacto@ocimpulsa.cl" className="text-lg font-bold text-[#0F2027] hover:text-[#CCA43B] transition-colors">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-[#0F2027]">Región de Coquimbo<br />y Antofagasta</p>
                        ...
                        <div className="bg-[#0F2027] text-white p-8 rounded-2xl shadow-xl flex flex-col justify-center min-h-[400px]">
                            ...
                            <Button
                                ...
                                className="w-full bg-[#CCA43B] text-[#0F2027] hover:bg-[#b88f28] font-bold text-lg py-6"
                            >
                                Agendar Diagnóstico
